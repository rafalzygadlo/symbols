...
BEGIN_EVENT_TABLE(CSBMSPanel,wxPanel)
...
CSBMSPanel::CSBMSPanel(wxWindow *parent)
...
void CSBMSPanel::OnMenu(wxContextMenuEvent &event)
{
...
void CSBMSPanel::OnShowMenu(wxCommandEvent &event)
{
	bool static a = false;
	a =!a;
...
void CSBMSPanel::OnManagement(wxCommandEvent &event)
{
	//m_Symbol->ShowManagement(m_Symbol);
}


void CSBMSPanel::OnGraph(wxCommandEvent &event)
{
	//m_Symbol->ShowGraph();
}


void CSBMSPanel::OnHtml(wxHtmlLinkEvent &event)
{
...
void CSBMSPanel::SetPageEmpty()
{
}

void CSBMSPanel::SetPage(CSBMS *ptr)
{
	void *db = DBConnect();
	if(db == NULL)
		return;
...
void CSBMSPanel::AlarmInfo(CSBMS *ptr)
{	
	wxString str;
	/*
...
void CSBMSPanel::SBMSInfo(void *db,int id_symbol)
{
	wxString sql = wxString::Format(_("SELECT * FROM `%s` WHERE id_symbol ='%d'"),TABLE_SBMS,id_symbol);
	my_query(db,sql);
...
void CSBMSPanel::BaseStationInfo(void *db, int id_base_station)
{
...
void CSBMSPanel::LightInfo(void *db,int id_symbol)
{
...
void CSBMSPanel::PictureInfo(void *db,CSymbol *ptr)
{
#ifndef WEBVIEW
...
#ifdef WEBVIEW
void CSBMSPanel::OnNavigationRequest(wxWebViewEvent& event)
{
